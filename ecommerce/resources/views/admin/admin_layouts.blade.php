...
<head>
    ...
    <title>Ecom WebApp Admin Panel</title>
...
<body>
    ...
    @else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> LeCarre</a></div>
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('admin.coupons')}}" class="nav-link">Add Coupons</a></li>
    ...
    <!-- codes below here is for the toastr -->
    <script>
