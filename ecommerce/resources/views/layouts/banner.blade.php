                        ...
                        <ul class="cat_menu">
                            ...
                            <li class="hassubs">
                                ...
                                <ul>
                                    ...
                                    <li class="hassubs">
                                        <a href="#">{{$subcat->subcategory_name}}<i
...
<div class="banner">
    ...
    <div class="container fill_height">
        <div class="row fill_height">
            <div class="banner_product_image"><img src="{{$slider->image_one }}" style="height:400px;" alt="">
            </div>
            <div class="col-lg-5 offset-lg-4 fill_height">
                <div class="banner_content">
                    ...
                    <div class="banner_price">
                        ...
                        <h2>${{$slider->product_price }}</h2>
                        @else
                        <span>${{$slider->product_price}}</span>${{$slider->discount_price}}
